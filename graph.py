...
Picture = list(range(rate[1])) + [24] * 823 # データの数をDocに合わせたOthersのデータ
Others = list(range(rate[2])) + [44] * 823# データの数をDocに合わせたWindowsのデータ
Windows= list(range(rate[3])) + [22] * 823 # データの数をDocに合わせたPictureのデータ
